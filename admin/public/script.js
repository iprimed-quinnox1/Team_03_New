...
myApp.config(function ($routeProvider) {
    $routeProvider
        ...
        .when('/logistics', {
            templateUrl: 'pages/logistics.html',
            controller: 'logistic'
        })
...
myApp.controller('logistic', function ($scope, $http) {
    ...
    $scope.logis = function () {
        ...
        $http.get("http://192.168.10.55:3000/logistics").then(function (response) {
    ...
    $scope.update = function (pstatus,itemId) {
        ...
        $http.post("http://192.168.10.55:3000/update", obj).then(function (response) {
            $scope.log(); 
        });
...
myApp.controller('display', function ($scope, $http) {
    ...
    $scope.cart = function () {
        ...
        $http.get("http://192.168.10.55:3000/display").then(function (response) {
             alert("successfully cart 7777!!!");
    ...
    $scope.deleteUser = function (p) {
       // var index = $scope.cart1.indexOf(p);
        var ob = { pid: p.pid };
        $http.post("http://192.168.10.55:3000/deleteUser", ob).then(function (response) {
            $scope.cart(); 
...
myApp.controller('display2', function ($scope, $http) {
    ...
    $scope.carts = function () {
        ...
        $http.get("http://192.168.10.55:3000/display2").then(function (response) {
            alert("successfull!!!");
 ...
 $scope.deleteUser2 = function (p) {
    ...
    var ob= { pid: p.pid };
    $http.post("http://192.168.10.55:3000/deleteUser2", ob).then(function (response) {
        //alert("successfully deleted!!!");  
       // window.location="http://192.168.10.55:3000/#/display2"; 
    $scope.carts();
...
myApp.controller('display3', function ($scope, $http) {
    ...
    $scope.cartss = function () {
        ...
        $http.get("http://192.168.10.55:3000/display3").then(function (response) {
            alert("successfully!!!");
...
$scope.deleteUser3 = function (p) {
    ...
    var ob= { pid: p.pid };
    $http.post("http://192.168.10.55:3000/deleteUser3", ob).then(function (response) {
        //alert("successfully deleted!!!");  
       // window.location="http://192.168.10.55:3000/#/display2"; 
    $scope.cartss();
...
myApp.controller('display4', function ($scope, $http) {
    ...
    $scope.cartsss = function () {
        ...
        $http.get("http://192.168.10.55:3000/display4").then(function (response) {
...
$scope.deleteUser4 = function (p) {
    ...
    var ob= { pid: p.pid };
    $http.post("http://192.168.10.55:3000/deleteUser4", ob).then(function (response) {
        //alert("successfully deleted!!!");  
       // window.location="http://192.168.10.55:3000/#/display2"; 
    $scope.cartsss();
...
myApp.controller('display5', function ($scope, $http) {
    ...
    $scope.cartssss = function () {
        ...
        $http.get("http://192.168.10.55:3000/display5").then(function (response) {
...
$scope.deleteUser5 = function (p) {
    ...
    var ob= { pid: p.pid };
    $http.post("http://192.168.10.55:3000/deleteUser5", ob).then(function (response) {
        //alert("successfully deleted!!!");  
       // window.location="http://192.168.10.55:3000/#/display2"; 
    $scope.cartssss();
...
myApp.controller("admin", function ($scope, $http) {
    ...
    $scope.sendData = function () {
        ...
        $http.post("http://192.168.10.55:3000/data", myOb).then(function (response) {
...
myApp.controller("category2", function ($scope, $http) {
    ...
    $scope.sendData = function () {
        ...
        $http.post("http://192.168.10.55:3000/data2", myOb).then(function (response) {
...
myApp.controller("category3", function ($scope, $http) {
    ...
    $scope.sendData = function () {
        ...
        $http.post("http://192.168.10.55:3000/data3", myOb).then(function (response) {

            if (response.data == 'true') {
                alert("successfully inserted in category 3 db!!!");
                window.location = "http://192.168.10.55:3000/#/display3";
            }
...
myApp.controller("category4", function ($scope, $http) {
    ...
    $scope.sendData = function () {
        ...
        $http.post("http://192.168.10.55:3000/data4", myOb).then(function (response) {

            if (response.data == 'true') {
                alert("successfully inserted in category 4 db!!!");
                window.location = "http://192.168.10.55:3000/#/display4";
            }
...
myApp.controller("category5", function ($scope, $http) {
    ...
    $scope.sendData = function () {
        ...
        $http.post("http://192.168.10.55:3000/data5", myOb).then(function (response) {

            if (response.data == 'true') {
                alert("successfully inserted in category 5 db!!!");
                window.location = "http://192.168.10.55:3000/#/display5";
            }
